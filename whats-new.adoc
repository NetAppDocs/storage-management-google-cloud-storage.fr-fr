...
summary: Découvrez les nouveautés de Google Cloud Storage dans NetApp Console. 
---
= Nouveautés de Google Cloud Storage dans la console NetApp
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Découvrez les nouveautés de Google Cloud Storage dans NetApp Console.
